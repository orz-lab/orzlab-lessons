// Linear Regression - Extended Scatter Plot with Trend Line
// Animation: Extended scatter plot with 20 data points and trend line

export function createExtendedScatterPlot(canvasId) {
    ...
    const options = {
        ...
        plugins: {
            title: {
                display: true,
                text: 'Biểu đồ 2: Mối quan hệ giữa Số giờ học và Điểm thi'
            },
            legend: {
                display: false
            },
